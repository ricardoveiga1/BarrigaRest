package com.restassured.barrigarest.tests;
...
import com.restassured.barrigarest.utils.DataUtils;
...
public class BarrigaTest extends BaseTest {
    ...
    @Test  //tive que alterar para BeforeClass para fazer executar apenas uma vez, o Before estava acumulado tokens, pois executa uma vez antes de cada teste
    public  void login(){  //precisa ser static devido ao BeforeClass
        ...
        response
                .then()
                    .statusCode(200)
                    //.body("token.json", is(notNullValue())).log().all()
        ...
        RestAssured.requestSpecification.header("Authorization", "JWT " + TOKEN); //faz com que o token.json vá em todas requisicoes
    }
